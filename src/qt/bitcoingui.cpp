...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsMenuAction->setStatusTip(tr("Send coins to a Lajcoin address"));
    ...
    coinJoinCoinsMenuAction->setStatusTip(tr("Send %1 funds to a Lajcoin address").arg(strCoinJoinName));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Lajcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message…"), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Lajcoin addresses"));
    m_load_psbt_action = new QAction(tr("&Load PSBT from file…"), this);
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed Lajcoin Transaction"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Lajcoin command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (fNetworkActive) {
        ...
        tooltip = tr("%n active connection(s) to Lajcoin network", "", count);
    } else {
