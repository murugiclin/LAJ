// Copyright (c) 2018-2023 The Lajcoin Core developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef LAJ_CRYPTO_BLS_BATCHVERIFIER_H
#define LAJ_CRYPTO_BLS_BATCHVERIFIER_H
...
#endif //LAJ_CRYPTO_BLS_BATCHVERIFIER_H
