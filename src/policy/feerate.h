...
const std::string CURRENCY_UNIT = "LAJ"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    LAJ_KB,      //!< Use LAJ/kB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::LAJ_KB) const;
