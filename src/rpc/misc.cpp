...
static RPCHelpMan debug()
{
    return RPCHelpMan{"debug",
        ...
        " - \"dash\" activates all Lajcoin-specific categories at once;\n"
...
static RPCHelpMan validateaddress()
{
    return RPCHelpMan{"validateaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The Lajcoin address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
static RPCHelpMan verifymessage()
{
    return RPCHelpMan{"verifymessage",
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The Lajcoin address to use for the signature."},
