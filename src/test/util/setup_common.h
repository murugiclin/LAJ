...
/* Initialize Lajcoin-specific components after chainstate initialization */
void LajcoinTestSetup(NodeContext& node, const CChainParams& chainparams);
void LajcoinTestSetupClose(NodeContext& node);
