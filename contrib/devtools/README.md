...
Provides utilities for managing copyright headers of `The Lajcoin Core
...
Setup
---------
Configuring the github-merge tool for the Lajcoin Core repository is done in the following way:
