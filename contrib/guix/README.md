# Bootstrappable Lajcoin Core Builds

This directory contains the files necessary to perform bootstrappable Lajcoin
Core builds.
...
To build Lajcoin Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Lajcoin Core version being built.
