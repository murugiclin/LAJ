...
"""Script for verifying Lajcoin Core release binaries
...
def main(args):
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Lajcoin Core binary release "
    ...
    for _, binary_filename in hashes_to_verify:
        ...
        if retval != 0:
            if retval == 1:
                ...
                print("gpg error. Do you have the Lajcoin Core binary release signing key installed?")
            print("gpg output:")
            print(indent(output, '\t'))
