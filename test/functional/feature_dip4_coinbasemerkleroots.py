#!/usr/bin/env python3
# Copyright (c) 2015-2024 The Lajcoin Core developers
...
from test_framework.test_framework import LajcoinTestFramework
...
class LLMQCoinbaseCommitmentsTest(LajcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as LajcoinTestFramework doesn't support this atm)
