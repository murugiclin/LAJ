...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 210 LAJ from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 LAJ in block rewards plus fees, but
        ...
        # Send 100 LAJ with subtract fee from amount
        ...
        # Sendmany 100 LAJ with subtract fee from amount
        ...
        if not self.options.descriptors:
            ...
            # This will raise an exception for attempting to get the private key of an invalid Lajcoin address
            assert_raises_rpc_error(-5, "Invalid Lajcoin address", self.nodes[0].dumpprivkey, "invalid")

            # This will raise an exception for attempting to set a label for an invalid Lajcoin address
            assert_raises_rpc_error(-5, "Invalid Lajcoin address", self.nodes[0].setlabel, "invalid address", "label")

            # This will raise an exception for importing an invalid address
            assert_raises_rpc_error(-5, "Invalid Lajcoin address or script", self.nodes[0].importaddress, "invalid")
