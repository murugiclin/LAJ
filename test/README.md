...
Before tests can be run locally, Lajcoin Core must be built.  See the [building instructions](/doc#building) for help.
...
Many Lajcoin specific tests require dash_hash. To install it:
