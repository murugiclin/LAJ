...
been added to support Lajcoin Platform. This update introduces versioning to
...
Governance
----------
Several improvements have been made to Lajcoin’s DAO governance system.
The governance proposal fee has been reduced from 5 Lajcoin to 1 Lajcoin following
...
the deprecation of wallet accounts in LajcoinCore v0.17 and introduction of PSBT
format.
...
---------------------------
This release introduces over 1000 updates from Bitcoin v0.18/v0.19/v0.20 as well as numerous updates from Bitcoin v0.21 and more recent versions. This includes multi-wallet support in the GUI, support for partially signed transactions (PSBT), Tor version 3 support, and a number of other updates that will benefit Lajcoin users. Bitcoin changes that do not align with Lajcoin’s product needs, such as SegWit and RBF, are excluded from our backporting. For additional detail on what’s included in Bitcoin, please refer to their release notes – v0.18, v0.19, v0.20.
