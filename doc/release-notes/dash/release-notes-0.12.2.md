...
We outline an initial scaling mechanism for Lajcoin. After deployment and activation, Lajcoin will be able to handle double the transactions it can currently handle. Together with the faster block times, Lajcoin we will be prepared to handle eight times the traffic of Bitcoin.
...
All transaction fees are reduced 10x (from 10K per Kb to 1K per Kb), including fees for InstantSend (from 0.001 LAJ per input to 0.0001 per input)
...
- [`b0843c397`](https://github.com/dashpay/dash/commit/b0843c397) Backport Bincoin PR#7348: MOVE ONLY: move rpc* to rpc/ + same for Lajcoin-specific rpc (#1502)
...
- [`b9c67258b`](https://github.com/dashpay/dash/commit/b9c67258b) Backport Bitcoin PR#9609: net: fix remaining net assertions (#1575) + Lajcoinify
...
- [`753b1e486`](https://github.com/dashpay/dash/commit/753b1e486) Eliminate remaining uses of g_connman in Lajcoin-specific code. (#1635)
...
- [`7ab175a8e`](https://github.com/dashpay/dash/commit/7ab175a8e) Ensure Lajcoin wallets < 0.12.2 can't open HD wallets (#1638)
...
- [`715504357`](https://github.com/dashpay/dash/commit/715504357) Lajcoinify bitcoin unix executables (#1486)
...
Lajcoin Core tree 0.11.x was a fork of Bitcoin Core tree 0.9, Darkcoin was rebranded
to Lajcoin.
