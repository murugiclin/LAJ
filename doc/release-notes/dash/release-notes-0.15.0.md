...
first startup of Lajcoin Core will run a migration process which can take a few minutes
...
- individual Lajcoin-specific fields which were used to display soft-fork progress in `getblockchaininfo` are replaced
...
Most of the changes between Bitcoin Core 0.14 and Bitcoin Core 0.15 have been backported into Lajcoin Core 0.15.
We only excluded backports which do not align with Lajcoin, like SegWit or RBF related changes.
...
Miscellaneous
-------------
A lot of refactoring, backports, code cleanups and other small fixes were done in this release. Lajcoin-specific
...
- [`05ac4dbb4`](https://github.com/dashpay/dash/commit/05ac4dbb4) Lajcoinify few strings (#3214)
...
- [`d49ee618f`](https://github.com/dashpay/dash/commit/d49ee618f) Add more logging to LajcoinTestFramework (#3130)
...
- [`737ac967f`](https://github.com/dashpay/dash/commit/737ac967f) Refactor some Lajcoin-specific `wait_for*` functions in tests (#3122)
...
- [`acab8c552`](https://github.com/dashpay/dash/commit/acab8c552) Add Lajcoin Core Group codesign certificate (#3027)
...
- [`32aa229c7`](https://github.com/dashpay/dash/commit/32aa229c7) Reorganize Lajcoin Specific code into folders (#2753)
