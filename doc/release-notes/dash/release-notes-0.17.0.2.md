...
from other quorum members. This allows Lajcoin Platform to obtain required
...
Platform support
----------------
Support for Lajcoin Platform has been expanded through the addition of a new
...
BLS update
----------
Lajcoin Core’s BLS signature library has been updated based on v1.0 of the
Chia BLS library to support migration to a new BLS signature scheme which will
be implemented in a future version of LajcoinCore. These changes will be made to
align with standards and improve security.

Network performance improvements
--------------------------------
This version of Lajcoin Core includes multiple optimizations to the network and
...
reliability. Activation of `SPORK_22_PS_MORE_PARTICIPANTS` in LajcoinCore v0.16
...
RPC changes
-----------
There are seven new RPC commands which are Lajcoin specific and seven new RPC
...
will be removed in LajcoinCore v0.18. Note that the deprecation of wallet accounts
...
Lajcoin users. Bitcoin changes that do not align with Lajcoin’s product needs, such
