...
We introduced a new signature format for Lajcoin-specific network messages,
...
However this option is only available in so called Lite Mode. In this mode, Lajcoin specific features are disabled, meaning
...
- introduced in Lajcoin Core 0.12.3.1: `allowprivatenet`, `bip9params`, `sporkaddr`, `devnet`;
...
mnprivkey during MN setup and NOT the one that controls the 1000 LAJ collateral) which should make the process of pairing with
...
We now use a recent masternode list to feed the hardcoded seed nodes list in Lajcoin Core. This list was previously
...
- [`08033ffe4`](https://github.com/dashpay/dash/commit/08033ffe4) Reject Lajcoin-specific messages from obsolete peers (#1983)
...
- [`532b9fa3d`](https://github.com/dashpay/dash/commit/532b9fa3d) Use OpenNetworkConnection instead of calling ConnectNode directly in Lajcoin code (#1857)
...
- [`4ea790377`](https://github.com/dashpay/dash/commit/4ea790377) Lajcoinify lib names (#2035)
...
- [`c65613350`](https://github.com/dashpay/dash/commit/c65613350) Switch masternode id in Lajcoin data structures from CTxIn to COutPoint (#1933)
...
- [`a7fa07a30`](https://github.com/dashpay/dash/commit/a7fa07a30) Drop BOOST_FOREACH and use references in loops (const ref where applicable, Lajcoin code only) (#1899)
