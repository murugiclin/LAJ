...
A bug in Lajcoin Core caused respends to not work before a received InstantSend transaction was confirmed in at least
one block. This is fixed in this release, so that InstantSend locked mempool transactions can be
respent immediately in Lajcoin Core (other wallets were not affected).
...
Previously, Lajcoin would re-request old transactions even though they were already known locally. This
...
in Bitcoin v0.15.1. This release of Lajcoin Core includes a backport of this fix.
