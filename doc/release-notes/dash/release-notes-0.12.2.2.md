...
To fix this issue in Lajcoin Core however, we had to backport a lot of other
...
Keeping a wallet with 1000 LAJ unlocked for 24/7 is definitely not a good idea
...
it should be possible to compile Lajcoin Core with `--disable-wallet` option now.
...
- [`9ad56fe18`](https://github.com/dashpay/dash/commit/9ad56fe18) Lajcoin related fixes for per-utxo DB
...
### Network/Sync:
- [`5d58dd90c`](https://github.com/dashpay/dash/commit/5d58dd90c) Make sure to clear setAskFor in Lajcoin submodules (#1730)
