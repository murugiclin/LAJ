...
At the first startup Lajcoin Core will run a migration process which can take
...
incompatible with older versions of Lajcoin Core, so a db migration path was
