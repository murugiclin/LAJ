...
- Core now categorizes asset unlock transactions as "Platform Transfers" on the Transactions tab in Lajcoin-Qt and in the output of the `gettransaction` RPC (#6131)
- Persist Coinjoin Denoms options changes made via GUI over restarts (#6208)
- Fix incorrect payment predictions for evonodes in Lajcoin-Qt and in RPC `masternode winners` (#6222)
