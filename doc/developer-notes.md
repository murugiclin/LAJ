...
- [Development guidelines](#development-guidelines)
    - [General Lajcoin Core](#general-dash-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
Lajcoin Core uses [Doxygen](https://www.doxygen.nl/) to generate its official documentation.
...
Lajcoin Core is a multi-threaded application, and deadlocks or other
...
Lajcoin Core can be compiled with various "sanitizers" enabled, which add
...
However, in open source software such as Lajcoin Core, where everyone uses
...
pay attention to for reviewers of Lajcoin Core code.

General Lajcoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers.
  ...
  - *Rationale*: Lajcoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion.
...
be sent upstream, but bugfixes may also be prudent to PR against Lajcoin Core so that they can be integrated
...
- Wallet RPCs call BlockUntilSyncedToCurrentChain to maintain consistency with
  ...
  - *Rationale*: In previous versions of Lajcoin Core, the wallet was always
...
- Use *invalid* Lajcoin addresses (e.g. in the constant array `EXAMPLE_ADDRESS`) for
