# Support for Output Descriptors in Lajcoin Core

Since Lajcoin Core v0.17, there is support for Output Descriptors. This is a
...
existing Lajcoin Core wallets, a convenience function `combo` is
...
All RPCs in Lajcoin Core will include the checksum in their output. Only
