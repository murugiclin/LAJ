...
Below are some notes on how to build Lajcoin Core for Windows.

The options known to work for building Lajcoin Core on Windows are:
...
Note that for WSL the Lajcoin Core source path MUST be somewhere in the default mount file system, for
