...
The Lajcoin Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Lajcoin Core requires the ZeroMQ API >= 4.0.0
...
using. Lajcoind appends an up-counting sequence number to each
