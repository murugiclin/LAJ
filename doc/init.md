...
### macOS
    ...
    Configuration file:  ~/Library/Application Support/LajcoinCore/dash.conf
    Data directory:      ~/Library/Application Support/LajcoinCore
    Lock file:           ~/Library/Application Support/LajcoinCore/.lock
...
setting the LAJD and FLAGS environment variables in the file
