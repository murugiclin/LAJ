# Fuzzing Lajcoin Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing Lajcoin Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
Every single pull request submitted against the Lajcoin Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Lajcoin Core more robust.
...
with certain assembly code from Lajcoin Core's code. See [developer notes on sanitizers](https://github.com/dashpay/dash/blob/develop/doc/developer-notes.md#sanitizers)
...
# Fuzzing Lajcoin Core using afl++

## Quickstart guide

To quickly get started fuzzing Lajcoin Core using [afl++](https://github.com/AFLplusplus/AFLplusplus):
...
# Fuzzing Lajcoin Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing Lajcoin Core using [Honggfuzz](https://github.com/google/honggfuzz):
...
## Fuzzing the Lajcoin Core P2P layer using Honggfuzz NetDriver

Honggfuzz NetDriver allows for very easy fuzzing of TCP servers such as Lajcoin
